...
describe("CandidateReviewArea", () => {
  ...
  it("disables complete review button while editing a candidate", () => {
    render(<CandidateReviewArea {...defaultProps} isEditingCandidateId="1" />);
  ...
  it("shows loading state during completion", () => {
    render(<CandidateReviewArea {...defaultProps} isLoadingCompletion={true} />);
  ...
  it("handles candidate rejection", async () => {
    ...
    const { user } = render(<CandidateReviewArea {...defaultProps} onRejectCandidate={onRejectCandidate} />);
  ...
  it("handles starting candidate edit", async () => {
    ...
    const { user } = render(<CandidateReviewArea {...defaultProps} onStartEditing={onStartEditing} />);
  ...
  it("handles completing review", async () => {
    ...
    const { user } = render(<CandidateReviewArea {...defaultProps} onCompleteReview={onCompleteReview} />);
